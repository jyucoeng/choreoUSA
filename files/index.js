...
const UUID = process.env.UUID || 'a5461024-8953-43da-a3de-93372b91ba15'; //若需要改UUID，需要在config.json里改为一致
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'MaZAbyhyaDVXxIfku8';   // 没用哪吒，把这个参数空着
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreous.900209.xyz';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZmQ4YWFkM2I2ZTczODYyNDliNjlkNTFjZTAwYmQ2ZmMiLCJ0IjoiNjRjNzM1NDctOWZkMy00MGVlLWFiOTktOTBhMTU1YjFjZGI4IiwicyI6Ik9XTmtZVGRsTXpZdE4yVTFNQzAwWkRRMExXRXpNVE10WmpVMU4yVmpOemM1WXpFNCJ9';
const CFIP = process.env.CFIP || 'www.visa.com.tw';
const NAME = process.env.NAME || 'ChoreoUSA';
